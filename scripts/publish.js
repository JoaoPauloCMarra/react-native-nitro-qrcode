...
async function main() {
  ...
  console.log("");
  log("📦 Publishing react-native-nitro-qrcode", "bold");
  console.log("");
  ...
  if (isDryRun) {
    ...
    console.log("");
    log(
      `✅ Successfully published react-native-nitro-qrcode@${version}`,
      "green"
    );
    log(`   https://www.npmjs.com/package/react-native-nitro-qrcode`, "cyan");
  }
