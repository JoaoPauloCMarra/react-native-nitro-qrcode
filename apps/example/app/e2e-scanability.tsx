...
const SCAN_CASES: readonly ScanCase[] = [
  ...
  { id: "classy", props: { value: "https://nitro.dev/scan/classy", preset: "classy" } },
  { id: "mosaic", props: { value: "https://nitro.dev/scan/mosaic", preset: "mosaic" } },
  { id: "fluid", props: { value: "https://nitro.dev/scan/fluid", preset: "fluid" } },
  { id: "classy-logo", props: { value: "https://nitro.dev/scan/classy-logo", preset: "classy", errorCorrectionLevel: "H", logoAreaSize: 48, logoPadding: 4, logo: <View style={{ flex: 1, backgroundColor: "#0F172A", alignItems: "center", justifyContent: "center" }}><Text style={{ color: "#FFFFFF", fontWeight: "700" }}>N</Text></View> } },
